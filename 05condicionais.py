...
#05 - Sistema de triagem de e-mails
assunto = input("Assunto email: ")
assunto = assunto.lower()

if "pagamento" or "boleto" in assunto:
    print("Ecaminhado para o setor financeiro")
elif "entrega" or "atraso" in assunto:
    print("Encaminhado para o setor de logística")
else:
    print("Encaminhado para o setor de atendimento geral")